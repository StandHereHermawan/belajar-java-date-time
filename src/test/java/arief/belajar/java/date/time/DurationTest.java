...
public class DurationTest {
    ...
    void create() {
        ...
        Duration duration2 = Duration.ofMinutes(11);
        Duration duration3 = Duration.ofMillis(13);
    ...
    void between() {
        ...
        Duration duration2 = Duration.between(LocalDateTime.now().plusHours(4), LocalDateTime.now());
        System.out.println(duration2);
